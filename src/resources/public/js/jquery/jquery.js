	...
	---------------------------------------------------------------------- */
      ...
      function setMatcher (
        ...
        return markFunction(function (seed, results, context, xml) {
          ...
          const elems = seed || multipleContexts(selector || '*',
      ...
      function matcherFromGroupMatchers (elementMatchers, setMatchers) {
        ...
        const superMatcher = function (seed, context, xml, results, outermost) {
          ...
          const dirrunsUnique = (dirruns += contextBackup == null
            ? 1
            : Math.random() || 0.1)
  ...
  function inspectPrefiltersOrTransports (
    ...
    function inspect (dataType) {
      ...
      jQuery.each(structure[dataType] || [], function (_, prefilterOrFactory) {
        const dataTypeOrTransport = prefilterOrFactory(options, originalOptions,
          jqXHR)
