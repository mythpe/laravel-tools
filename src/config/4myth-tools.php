...
return [
    ...
    */
    ...
    "date_format"                   => [
        ...
        'datetime_long'     => "Y/m/d • H:i",
        'readable'          => "d M, Y • g:i A",
        'readable_long'     => "d M, Y • H:i",
        'readable_day'      => "l d M, Y • g:i A",
        'readable_day_long' => "l d M, Y • H:i",
        'log'               => 'Y-m-d',
        'logger'            => 'YmdHis',
    ],
    ...
    */
     ...
     * Example: '*' for all
     */
    'js_lang_command_files'         => ['attributes', 'choice', 'const', 'global', 'labels'],
